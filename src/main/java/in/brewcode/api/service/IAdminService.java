...
public interface IAdminService {
	public AuthorDto findByUserName(String userName) throws UserNotFoundException;

	public List<AuthorDto> findAuthorsByRoleName(String rolename) throws RoleNotFoundException;
	...
	public void addRole(RoleDto role) throws PrivilegeNotFoundException, RoleAlreadyExistsException;
	...
	public void updatePrivilegesOfRole(RoleDto roleDto)
			throws RoleNotFoundException, PrivilegeNotFoundException, RoleAlreadyExistsException;
	...
	public void deleteRole(String roleName) throws RoleNotFoundException, RoleInUseException;
